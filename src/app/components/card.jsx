...
//             console.log("📤 Réponse Cloudinary :", data); // Ajout du log pour voir la réponse
...
//         console.log("📤 Envoi des données :", { title, description, image });
...
//                 <form className="border-black border p-4 rounded-md" onSubmit={handleSubmit}>
...
//                         <Input id="image" type="file" onChange={handleImageUpload} required />
...
//                         <Button type="button" onClick={() => setImage("") && setDescription("") && setTitle("")}>Cancel</Button>
